...
class SiteController extends Controller {
    ...
    public function actionA_action() {
     $data = array ( 1 => ' USA ' , 2 => ' France ' , 3 => ' Japan ' );
     foreach ($data as $value->$name)
     {
         echo Html::tag('option',[' value ' => $value,$name,true]);
     }
 }
        ...
        if ($model->load(Yii::$app->request->post())) {
            if ($model->validate()) {
                ...
                if ($table->insert()) {
                    ...
                    $body .= "<a href='http://localhos/web/index.php?r=site/confirm&id=" . $id . "&authKey=" . $authKey . "'>Confirmar</a>";
    ...
    public function actionAjax() {
        ...
        return $this->render("formularioajax", ['model' => $model, 'msg' => $msg]);
    }
