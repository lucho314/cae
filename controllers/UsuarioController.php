    ...
    public function actionCrearadmin()
    {
        ...
        if($model->load(Yii::$app->request->post()))
        {
            if($model->validate())
            {
                ...
                $sql2="insert into usuario (dni,nombre_usuario,contrasenia,privilegio,authKey,accessToken,email) value ('$model->dni','$model->nombre_usuario','$password',1,'$authKey','$accessToken','$model->email')";
                try
                {
    ...
    public function actionCrearsubcomision()
    {
        ...
        if($model->load(Yii::$app->request->post()))
        {
            if($model->validate())
            {
                ...
                $transaction = $connection->beginTransaction();
                $sql1="insert into persona (dni,nombre,apellido,domicilio,telefono,email) value ('$model->dni','$model->nombre','$model->apellido','$model->domicilio','$model->telefono','$model->email')";
                $sql2="insert into usuario (dni,nombre_usuario,contrasenia,privilegio) value ('$model->dni','$model->nombre_usuario','$model->contrasenia',2)"; 
