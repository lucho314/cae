...
<article class="col-xs-12 col-md-10">
    <div class="row">
        ...
        <a href="<?= Url::toRoute(["evento/conflista",'id'=>'confirmar']) ?>"  class="btn btn-default" style="float:right;" id="go_paso_b">Confirmar<span class="glyphicon glyphicon-chevron-right"></span></a>
    </div>
</article>
