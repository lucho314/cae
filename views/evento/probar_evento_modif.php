    ...
    <div class="row">
        <div class="col-xs-12 col-md-6">
            <div class="form-group">
                <label for="id_evento">Nombre:</label>
                <?= $form->field($model, "id_evento")->input("text", ["placeholder" => "Nombre de evento", "class" => "form-control"])->label(false) ?>   
            </div>
        ...
        <div class="col-xs-12 col-md-6">
            ...
            <div class="botones">
                ...
                <a href="<?= Url::toRoute("evento/modificar") ?>" class="btn btn-default">Atras</a>
            </div>
        </div>
    </div>
    <?php $form->end() ?>
